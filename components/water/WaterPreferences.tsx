    ...
    <DialogDrawer open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogDrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DialogDrawerHeader>
            <DialogDrawerTitle>Water Preferences</DialogDrawerTitle>
            <DialogDrawerDescription>Set your water preferences.</DialogDrawerDescription>
          </DialogDrawerHeader>
            ...
            <CustomCard cardTitle="Afternoon">
              <CardContent>
                <div className="mb-4 grid grid-cols-[25px_1fr] items-start pb-4 last:mb-0 last:pb-0">
                  <span className="flex h-2 w-2 translate-y-1 rounded-full bg[#F7BE7A]" />
                  <div className="space-y-2">
                    <p className="leading-none">6:00 PM, Daily, 200 ml</p>
                  </div>
                </div>
              </CardContent>
            </CustomCard>
        ...
        <DialogDrawerFooter className="mx-auto w-full max-w-sm">
          <Button className="bg-[#6BD9E2] hover:bg-[#53B1C9] text-md h-12">
            Edit Preferences
          </Button>
